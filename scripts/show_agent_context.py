...
def show_static_instructions():
    ...
    agent = ClankerAgent(ModelTier.LOW)
...
def show_summary(instructions, daemon_hint, app_hints, tool_count):
    ...
    print("=" * 80)
    print("✅ Using 'instructions' instead of 'system_prompt'")
    print("✅ Dynamic instructions refresh each request (no stale state)")
    print("✅ Clear separation: Static (identity) vs Dynamic (state) vs Tools (auto)")
    print("✅ Better for console sessions - context doesn't accumulate conflicting info")
